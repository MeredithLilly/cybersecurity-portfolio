...
- Real IP addresses, hostnames, or network diagrams tied to live systems
- Proprietary, employer, or client data
- Logs or artifacts from real-world environments

Any sensitive values shown in documentation are **sanitized, redacted, or simulated**.
...
- Improving system hardening and security awareness

They are **not intended for unauthorized access, exploitation, or misuse**.  
...
- Content that violates responsible disclosure practices

Please report it by:
- Opening a **private issue** (if available), or
- Contacting me directly via GitHub

Issues will be reviewed and remediated promptly.
